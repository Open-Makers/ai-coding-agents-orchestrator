# Prompts — Derived From Implementation Plan

This prompt set is aligned with `doc/implementation_plan.md` and intended for building the Go orchestrator from scratch.
